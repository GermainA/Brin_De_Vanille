<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
     <title>Brin de vanille</title>
    <meta name="description" content="Brin de Vanille vous propose de délicieux produits frais, entièrement faits maison. Moins sucrés et sans conservateur, pour vous offrir une dégustation de haute qualité et un vrai moment de gourmandise.">

    <!-- Liens vers les fichiers favicons -->
